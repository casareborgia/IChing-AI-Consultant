...
SOURCE_LABEL = {
    ...
    # 주자 『본의』. 정전과 라벨을 갈라 두는 이유는 번역자가 성격을 알아야 하기
    # 때문이다 — 본의는 점법(占法)을 말하는 자리가 많아 "이 괘를 얻으면 …하다"
    # 같은 어투가 원문에 실제로 들어 있다. 정전 주석인 줄 알고 옮기면 그 어투가
    # 임의로 지워지거나, 반대로 예언처럼 부풀려진다.
    "benui_guasa":   "괘사에 대한 주자 『본의(本義)』 주석",
    "benui_line":    "{pos}효 효사에 대한 주자 『본의(本義)』 주석",
    "benui_tanjon":  "단전에 대한 주자 『본의(本義)』 주석",
    "benui_daesang": "대상전에 대한 주자 『본의(本義)』 주석",
    "benui_sosang":  "{pos}효 소상전에 대한 주자 『본의(本義)』 주석",
}
